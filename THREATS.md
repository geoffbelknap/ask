...
| **Runtime tampering** | Traditional | — | The agent's Runtime — container image, binaries, dependencies — is modified before or during operation, either through supply chain compromise or host-level access. | Critical — a compromised runtime undermines all governance. Relates to Tenet 5. |
