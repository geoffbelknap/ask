...
**Status:** integrated. Landed for ASK 2026.07, ahead of [the invariants split](proposed-invariants-split.md). Kept for the rationale — in particular the case for outright deletion, and why the layers are cut where they are.
